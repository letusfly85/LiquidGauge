#
#  Be sure to run `pod spec lint Liquid-Gauge.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/letusfly85/LiquidGauge"
  ...
  s.author             = { "Liquid Gauge" => "letusfly85@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/letusfly85/LiquidGauge.git", :tag => "0.0.1" }
